  ...
  return (
    <Form {...form}>
      <form 
        ...
        className="space-y-4" 
        data-testid="flashcard-generation-form"
      >
        <FormField
            ...
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  ...
                  disabled={disabled}
                  data-testid="flashcard-generation-input"
        ...
        />
        <Button type="submit" disabled={disabled || !localValue.trim()} data-testid="generate-flashcard-button">
          Generuj fiszkę
        </Button>
      </form>
    </Form>
